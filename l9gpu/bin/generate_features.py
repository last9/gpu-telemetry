...
from l9gpu.monitoring.features import feature_definitions

# This is the directory containing the feature classes
feature_dir = "../l9gpu/features/feature_definitions"
import_dir = "l9gpu.features.feature_definitions"
outfile_path = "../l9gpu/features/gen/"
...
# To update:
# - Edit `l9gpu/features/feature_definitions/health_checks_features.py`
# - Run `python bin/generate_features.py`
# - Run `ufmt format l9gpu`
