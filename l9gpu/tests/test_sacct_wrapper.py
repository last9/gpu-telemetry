...
from l9gpu.monitoring.cli.sacct_wrapper import (
    filter_sacct_lines,
...
from l9gpu.monitoring.date import ClosedInterval
...
def test_cli_no_patch(
    ...
    # called below
    mock = mocker.patch("l9gpu.monitoring.cli.sacct_wrapper.get_patched_sacct_cmd")
