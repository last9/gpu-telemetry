...
from l9gpu.exporters.stdout import Stdout

from l9gpu.monitoring.cli.slurm_job_monitor import CliObject, main
from l9gpu.monitoring.clock import Clock, time_to_time_aware
...
from l9gpu.monitoring.utils.parsing.stdout import parse_delimited
from l9gpu.tests import data
...
class FakeSlurmClient(SlurmCliClient):
    def squeue(
        ...
        return self._parse_squeue(
            gen_squeue_lines=(
                line.strip()
                for line in resources.files("l9gpu.tests")
