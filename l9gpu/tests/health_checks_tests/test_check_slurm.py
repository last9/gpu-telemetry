...
def test_slurmctld_count(
    ...
    result = runner.invoke(
        slurmctld_count,
        f"test_cluster prolog --log-folder={tmp_path} --sink=do_nothing --slurmctld-count=2",
...
def test_cluster_availability(
    ...
    result = runner.invoke(
        cluster_availability,
        f"test_cluster prolog --log-folder={tmp_path} --critical_threshold=25 --warning_threshold=15 --sink=do_nothing",
