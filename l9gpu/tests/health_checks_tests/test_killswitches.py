...
from l9gpu.health_checks.checks.check_nvidia_smi import NvidiaSmiCli
from l9gpu.health_checks.cli.health_checks import health_checks as hc_main
...
from l9gpu.tests.health_checks_tests.test_nvidia_smi import (
...
def test_killswitches(
    ...
    if "nvidia-smi" in command:
        ...
        result = runner.invoke(
            hc_main,
            f"--features-config={config_path} {command} test_cluster nagios --log-folder={tmp_path} --sink=do_nothing",
