...
from l9gpu.health_checks.checks.check_syslogs import check_syslogs, Syslog
...
def test_link_flaps(
    ...
    result = runner.invoke(
        check_syslogs,
        f"link-flaps test_cluster prolog --log-folder={tmp_path} --sink=do_nothing",
...
def test_xid(
    ...
    result = runner.invoke(
        check_syslogs,
        f"xid test_cluster prolog --log-folder={tmp_path} --sink=do_nothing",
        obj=fake_syslog_tester,
    )
...
def test_io_errors(
    ...
    result = runner.invoke(
        check_syslogs,
        f"io-errors test_cluster prolog --log-folder={tmp_path} --sink=do_nothing",
        obj=fake_syslog_tester,
    )
...
def test_exception_handling(
    ...
    result = runner.invoke(
        check_syslogs,
        f"{check} test_cluster prolog --log-folder={tmp_path} --sink=do_nothing",
        obj=fake_syslog_obj,
    )
