...
from l9gpu.health_checks.checks.check_iblink import (
    check_iblink,
    IBLinkIssue,
    IBLinkState,
)
from l9gpu.health_checks.checks.check_pci import PciDevice
from l9gpu.health_checks.types import ExitCode
from l9gpu.tests.data import health_checks
...
def test_check_iblink(
    ...
    result = runner.invoke(
        check_iblink,
        f"test_cluster prolog --log-folder={tmp_path} --manifest_file={manifest_file} --sink=do_nothing",
        obj=iblink_tester,
    )
