...
def test_check_sel(
    ...
    result = runner.invoke(
        check_ipmitool,
        f"check-sel test_cluster prolog --log-folder={tmp_path} --sink=do_nothing",
        obj=sel_tester,
    )
...
def test_clear_sel(
    ...
    result = runner.invoke(
        check_ipmitool,
        f"check-sel test_cluster prolog --log-folder={tmp_path} --sink=do_nothing --clear_log_threshold=1",
