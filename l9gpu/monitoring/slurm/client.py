...
from l9gpu.monitoring.slurm.constants import (
    PENDING_RESOURCE_REASONS,
    SLURM_CLI_DELIMITER,
)

from l9gpu.monitoring.slurm.sacct import get_sacct_lines
from l9gpu.monitoring.utils.shell import _gen_lines, _popen

from l9gpu.schemas.slurm.sdiag import Sdiag
from l9gpu.schemas.slurm.sinfo import Sinfo
from l9gpu.schemas.slurm.sinfo_node import SinfoNode
from l9gpu.schemas.slurm.sinfo_row import SinfoRow
from l9gpu.schemas.slurm.sprio import SPRIO_FORMAT_SPEC, SPRIO_HEADER
from l9gpu.schemas.slurm.squeue import JOB_DATA_SLURM_FIELDS, JobData

if TYPE_CHECKING:
    from _typeshed import DataclassInstance


def _get_slurm_version() -> tuple[int, ...]:
    try:
        out = subprocess.check_output(["sinfo", "--version"], text=True).strip()
