...
from l9gpu.health_checks.click import (
    common_arguments,
    telemetry_argument,
    timeout_argument,
)
...
from l9gpu.health_checks.types import CHECK_TYPE, ExitCode, LOG_LEVEL
...
@click.option(
    "--hostlist",  # TODO: handle comma-separated list of valid hostnames like hostname1,hostname2
    type=str,
...
@click.option(
    ...
    required=True,  # TODO: include external binaries within l9gpu package
)
@click.option(
    "--nccl-topts",
    type=str,
...
def check_nccl(
    ...
    # TODO: include external binaries within this package
