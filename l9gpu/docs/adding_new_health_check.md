...
Next, define your check command inside this file, add it to the [`l9gpu/health_checks/checks/__init__.py`](https://github.com/last9/gpu-telemetry/blob/main/l9gpu/health_checks/checks/__init__.py), and include it in the [`l9gpu/health_checks/cli/health_checks.py`](https://github.com/last9/gpu-telemetry/blob/main/l9gpu/health_checks/cli/health_checks.py).
